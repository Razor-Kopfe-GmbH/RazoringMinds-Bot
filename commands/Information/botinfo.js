...
module.exports.run = async (bot, message, args) => {
    ...
    const embed = new MessageEmbed()
      .setTitle('RazoringMinds\'s Statistics')
      .addField('Client', `\`\`\`asciidoc\n${clientStats}\`\`\``)
      .addField('Server', `\`\`\`asciidoc\n${serverStats}\`\`\``)
      .addField(
        'Links', 
        '**[Invite Me](https://discordapp.com/oauth2/authorize?client_id=523551992279203840&scope=bot&permissions=8) | ' +
        '[Support Server](https://discord.gg/PC6RWFn)**'
      )
